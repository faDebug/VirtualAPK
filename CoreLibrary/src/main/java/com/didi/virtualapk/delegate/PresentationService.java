 ...
 * @author johnsonlee
 */
public class PresentationService extends LocalService {
    
    private static final String TAG = Constants.TAG_PREFIX + "PresentationService";
